...
class Header extends Component {
  ...
  async componentDidUpdate(prevProps, prevState) {
    ...
    if (web3Data.accounts[0] !== prevProps.web3Data.accounts[0]) {
      ...
      else if (localStorage.getItem("fibitAuthToken"))
              ...
              <MobileSidebar>
                ...
                >
                  <MobInner>
                    ...
                    >
                      <Moremenu>
                        <div className="more-parts">
                          <NavLink
                            to={{ pathname: "https://medium.com/@Fibit.io" }}
                            target="_blank"
                          >
                            Fibit Pro Blog
                          </NavLink>
                    ...
                    <FooterrightLinks>
                      <Link
                        to={{ pathname: "https://www.instagram.com/Fibit.io/" }}
                        target="_blank"
                      >
                        Instagram
                      </Link>
                      <Link
                        to={{ pathname: "https://twitter.com/Fibit_io" }}
                        target="_blank"
                      >
                        Twitter
                      </Link>
